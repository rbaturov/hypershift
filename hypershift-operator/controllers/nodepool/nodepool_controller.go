...
func (r *NodePoolReconciler) reconcile(ctx context.Context, hcluster *hyperv1.HostedCluster, nodePool *hyperv1.NodePool) (ctrl.Result, error) {
	...
	err = r.HandlePerformanceProfileStatus(ctx, performanceProfileStatusConfigMap, nodePool, controlPlaneNamespace)
	if err != nil {
		return ctrl.Result{}, err
	}
...
// HandlePerformanceProfileStatus checks for performance profile status updates, and reflects them in the nodepool status conditions
func (r *NodePoolReconciler) HandlePerformanceProfileStatus(ctx context.Context, performanceProfileStatusConfigMap *corev1.ConfigMap, nodePool *hyperv1.NodePool, controlPlaneNamespace string) error {
